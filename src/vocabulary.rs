...
pub fn get_vocabulary() -> HashMap<&'static str, &'static str> {
    ...
    vocab.insert("one", "1️⃣");
    // --- NEW EMOJI WORDS AND COMPOUND ENTRIES ---
    // Compound/phrase emoji words
    vocab.insert("sunrise", "🌅");
    vocab.insert("sunset", "🌇");
    vocab.insert("starfish", "⭐🐟");
    vocab.insert("firetruck", "🔥🚒");
    vocab.insert("rainbow flag", "🏳️‍🌈");
    vocab.insert("ice cream", "🍦");
    vocab.insert("birthday cake", "🎂");
    vocab.insert("soccer ball", "⚽");
    vocab.insert("basketball", "🏀");
    vocab.insert("baseball", "⚾");
    vocab.insert("tennis ball", "🎾");
    vocab.insert("football", "🏈");
    vocab.insert("hot dog", "🌭");
    vocab.insert("french fries", "🍟");
    vocab.insert("popcorn", "🍿");
    vocab.insert("chocolate cake", "🍫🍰");
    vocab.insert("apple pie", "🍎🥧");
    vocab.insert("peach pie", "🍑🥧");
    vocab.insert("pineapple pizza", "🍍🍕");
    vocab.insert("cheeseburger", "🧀🍔");
    vocab.insert("bacon and eggs", "🥓🥚");
    vocab.insert("pancakes", "🥞");
    vocab.insert("spaghetti", "🍝");
    vocab.insert("taco", "🌮");
    vocab.insert("burrito", "🌯");
    vocab.insert("sushi roll", "🍣");
    vocab.insert("shrimp tempura", "🍤");
    vocab.insert("avocado toast", "🥑🍞");
    vocab.insert("grilled cheese", "🧀🍞");
    vocab.insert("fruit salad", "🍎🍌🍇🥝");
    vocab.insert("chicken nuggets", "🍗🟫");
    vocab.insert("fried chicken", "🍗🍳");
    vocab.insert("steak dinner", "🥩🍽️");
    vocab.insert("ice water", "🧊💧");
    vocab.insert("lemonade", "🍋🥤");
    vocab.insert("coffee cup", "☕");
    vocab.insert("tea cup", "🍵");
    vocab.insert("beer mug", "🍺");
    vocab.insert("wine glass", "🍷");
    vocab.insert("champagne", "🍾🥂");
    vocab.insert("birthday party", "🎂🥳");
    vocab.insert("wedding cake", "👰🎂");
    vocab.insert("wedding ring", "💍");
    vocab.insert("love letter", "💌");
    vocab.insert("broken heart", "💔");
    vocab.insert("heart eyes", "😍");
    vocab.insert("facepalm", "🤦");
    vocab.insert("thumbs up", "👍");
    vocab.insert("thumbs down", "👎");
    vocab.insert("peace sign", "✌️");
    vocab.insert("victory hand", "✌️");
    vocab.insert("clapping hands", "👏");
    vocab.insert("raising hands", "🙌");
    vocab.insert("folded hands", "🙏");
    vocab.insert("high five", "🙌");
    vocab.insert("fist bump", "👊");
    vocab.insert("handshake", "🤝");
    vocab.insert("hug", "🤗");
    vocab.insert("sleepy face", "😪");
    vocab.insert("crying face", "😢");
    vocab.insert("laughing face", "😂");
    vocab.insert("angry face", "😠");
    vocab.insert("party popper", "🎉");
    vocab.insert("fireworks", "🎆");
    vocab.insert("rocket ship", "🚀");
    vocab.insert("alien spaceship", "👽🛸");
    vocab.insert("earth globe", "🌍");
    vocab.insert("full moon", "🌕");
    vocab.insert("crescent moon", "🌙");
    vocab.insert("shooting star", "🌠");
    vocab.insert("milky way", "🌌");
    vocab.insert("mountain range", "🏔️");
    vocab.insert("desert island", "🏝️");
    vocab.insert("cityscape", "🏙️");
    vocab.insert("school bus", "🚌");
    vocab.insert("police car", "🚓");
    vocab.insert("fire engine", "🚒");
    vocab.insert("ambulance", "🚑");
    vocab.insert("delivery truck", "🚚");
    vocab.insert("tractor", "🚜");
    vocab.insert("race car", "🏎️");
    vocab.insert("roller coaster", "🎢");
    vocab.insert("ferris wheel", "🎡");
    vocab.insert("carousel horse", "🎠");
    vocab.insert("circus tent", "🎪");
    vocab.insert("magic wand", "🪄");
    vocab.insert("crystal ball", "🔮");
    vocab.insert("jack o lantern", "🎃");
    vocab.insert("snowman", "☃️");
    vocab.insert("snowflake", "❄️");
    vocab.insert("rain cloud", "🌧️");
    vocab.insert("lightning bolt", "⚡");
    vocab.insert("tornado", "🌪️");
    vocab.insert("volcano eruption", "🌋💥");
    vocab.insert("earthquake", "🌎💥");
    vocab.insert("tsunami", "🌊💥");
    vocab.insert("campfire", "🔥🏕️");
    vocab.insert("treehouse", "🌳🏠");
    vocab.insert("birdhouse", "🐦🏠");
    vocab.insert("doghouse", "🐕🏠");
    vocab.insert("catnap", "🐈💤");
    vocab.insert("dogwalk", "🐕🚶");
    vocab.insert("catwalk", "🐈🚶");
    vocab.insert("fishbowl", "🐟🟦");
    vocab.insert("goldfish", "🥇🐟");
    vocab.insert("butterfly", "🦋");
    vocab.insert("ladybug", "🐞");
    vocab.insert("dragonfly", "🐉🦋");
    vocab.insert("honeybee", "🍯🐝");
    vocab.insert("spiderweb", "🕷️🕸️");
    vocab.insert("ant hill", "🐜⛰️");
    vocab.insert("beehive", "🐝🏠");
    vocab.insert("snail mail", "🐌✉️");
    vocab.insert("email", "📧");
    vocab.insert("phone call", "📞");
    vocab.insert("video call", "🎥📞");
    vocab.insert("selfie", "🤳");
    vocab.insert("group selfie", "👥🤳");
    vocab.insert("family photo", "👨‍👩‍👧‍👦📸");
    vocab.insert("graduation cap", "🎓");
    vocab.insert("school desk", "🏫🪑");
    vocab.insert("homework", "🏠📄");
    vocab.insert("classroom", "🏫👩‍🏫");
    vocab.insert("science lab", "🔬🏫");
    vocab.insert("art class", "🎨🏫");
    vocab.insert("music lesson", "🎵👩‍🏫");
    vocab.insert("sports team", "🏈👥");
    vocab.insert("swimming pool", "🏊‍♂️🏊‍♀️");
    vocab.insert("tennis match", "🎾🤺");
    vocab.insert("chess game", "♟️🎲");
    vocab.insert("video game", "🎮");
    vocab.insert("board game", "🎲");
    vocab.insert("card game", "🃏");
    vocab.insert("dice roll", "🎲");
    vocab.insert("magic trick", "🪄🎩");
    vocab.insert("birthday wish", "🎂⭐");
    vocab.insert("new year", "🎆🗓️");
    vocab.insert("valentine", "💘");
    vocab.insert("christmas tree", "🎄");
    vocab.insert("easter egg", "🥚🐣");
    vocab.insert("halloween", "🎃");
    vocab.insert("thanksgiving", "🦃");
    vocab.insert("independence day", "🎆🇺🇸");
    vocab.insert("earth day", "🌍🌱");
    vocab.insert("mother's day", "👩❤️");
    vocab.insert("father's day", "👨❤️");
    vocab.insert("siblings", "👨‍👩‍👧‍👦");
    vocab.insert("grandparents", "👴👵");
    vocab.insert("best friend", "👫");
    vocab.insert("boyfriend", "👦❤️");
    vocab.insert("girlfriend", "👧❤️");
    vocab.insert("husband", "👨💍");
    vocab.insert("wife", "👩💍");
    vocab.insert("baby bottle", "🍼");
    vocab.insert("stroller", "🛒👶");
    vocab.insert("tooth fairy", "🧚🦷");
    vocab.insert("superhero", "🦸");
    vocab.insert("supervillain", "🦹");
    vocab.insert("pirate ship", "🏴‍☠️🚢");
    vocab.insert("treasure chest", "🪙🗃️");
    vocab.insert("map", "🗺️");
    vocab.insert("compass", "🧭");
    vocab.insert("telescope", "🔭");
    vocab.insert("microscope", "🔬");
    vocab.insert("test tube", "🧪");
    vocab.insert("paint brush", "🖌️");
    vocab.insert("pencil", "✏️");
    vocab.insert("notebook", "📓");
    vocab.insert("calendar", "📅");
    vocab.insert("alarm clock", "⏰");
    vocab.insert("stopwatch", "⏱️");
    vocab.insert("hourglass", "⏳");
    vocab.insert("light bulb", "💡");
    vocab.insert("flashlight", "🔦");
    vocab.insert("battery", "🔋");
    vocab.insert("plug", "🔌");
    vocab.insert("toolbox", "🧰");
    vocab.insert("hammer", "🔨");
    vocab.insert("wrench", "🔧");
    vocab.insert("screwdriver", "🪛");
    vocab.insert("saw", "🪚");
    vocab.insert("paint palette", "🎨");
    vocab.insert("shopping cart", "🛒");
    vocab.insert("credit card", "💳");
    vocab.insert("money bag", "💰");
    vocab.insert("banknote", "💵");
    vocab.insert("coin", "🪙");
    vocab.insert("receipt", "🧾");
    vocab.insert("package", "📦");
    vocab.insert("mailbox", "📫");
    vocab.insert("envelope", "✉️");
    vocab.insert("paperclip", "📎");
    vocab.insert("pushpin", "📌");
    vocab.insert("scotch tape", "📏🧻");
    vocab.insert("bookmark", "🔖");
    vocab.insert("trophy cup", "🏆");
    vocab.insert("medal", "🏅");
    vocab.insert("sports medal", "🥇");
    vocab.insert("ribbon", "🎀");
    vocab.insert("crown", "👑");
    vocab.insert("gemstone", "💎");
    vocab.insert("crystal", "🔮");
    vocab.insert("diamond ring", "💍");
    vocab.insert("wedding dress", "👰");
    vocab.insert("tuxedo", "🤵");
    vocab.insert("ballet shoes", "🩰");
    vocab.insert("running shoes", "👟");
    vocab.insert("boots", "🥾");
    vocab.insert("flip flops", "🩴");
    vocab.insert("socks", "🧦");
    vocab.insert("gloves", "🧤");
    vocab.insert("scarf", "🧣");
    vocab.insert("hat", "🎩");
    vocab.insert("sunglasses", "🕶️");
    vocab.insert("umbrella", "☂️");
    vocab.insert("backpack", "🎒");
    vocab.insert("luggage", "🧳");
    vocab.insert("tent", "⛺");
    vocab.insert("sleeping bag", "🛌");
    vocab.insert("camping", "🏕️");
    vocab.insert("mountain climbing", "🧗");
    vocab.insert("surfing", "🏄");
    vocab.insert("skiing", "🎿");
    vocab.insert("snowboarding", "🏂");
    vocab.insert("skateboarding", "🛹");
    vocab.insert("roller skating", "🛼");
    vocab.insert("biking", "🚴");
    vocab.insert("motorcycling", "🏍️");
    vocab.insert("driving", "🚗");
    vocab.insert("flying", "✈️");
    vocab.insert("sailing", "⛵");
    vocab.insert("rowing", "🚣");
    vocab.insert("fishing", "🎣");
    vocab.insert("hiking", "🥾");
    vocab.insert("gardening", "🌱🌿");
    vocab.insert("reading", "📖");
    vocab.insert("writing", "✍️");
    vocab.insert("drawing", "✏️");
    vocab.insert("painting", "🎨");
    vocab.insert("photography", "📷");
    vocab.insert("cooking", "🍳");
    vocab.insert("baking", "🥧");
    vocab.insert("cleaning", "🧹");
    vocab.insert("shopping", "🛍️");
    vocab.insert("traveling", "🌍✈️");
    vocab.insert("working", "💼");
    vocab.insert("studying", "📚");
    vocab.insert("teaching", "👩‍🏫");
    vocab.insert("learning", "📚");
    vocab.insert("playing", "🎮");
    vocab.insert("singing", "🎤");
    vocab.insert("dancing", "💃");
    vocab.insert("exercising", "🏋️");
    vocab.insert("meditating", "🧘");
    vocab.insert("sleeping", "😴");
    vocab.insert("dreaming", "💭");
    vocab.insert("thinking", "🤔");
    vocab.insert("laughing", "😂");
    vocab.insert("crying", "😭");
    vocab.insert("hugging", "🤗");
    vocab.insert("kissing", "💋");
    vocab.insert("arguing", "🤬");
    vocab.insert("apologizing", "🙏");
    vocab.insert("forgiving", "🤝");
    vocab.insert("helping", "🆘");
    vocab.insert("saving", "💾");
    vocab.insert("winning", "🏆");
    vocab.insert("losing", "😞");
    vocab.insert("celebrating", "🥳");
    vocab.insert("relaxing", "😌");
    vocab.insert("waiting", "⏳");
    vocab.insert("hoping", "🙏");
    vocab.insert("wishing", "⭐");
    vocab.insert("loving", "❤️");
    vocab.insert("hating", "😠");
    vocab.insert("fearing", "😱");
    vocab.insert("enjoying", "😋");
    vocab.insert("missing", "😢");
    vocab.insert("remembering", "💾");
    vocab.insert("forgetting", "😵");
    vocab.insert("discovering", "🔭");
    vocab.insert("exploring", "🧭");
    vocab.insert("inventing", "💡");
    vocab.insert("creating", "✨");
    vocab.insert("building", "🔨");
    vocab.insert("fixing", "🔧");
    vocab.insert("breaking", "💥");
    vocab.insert("cleaning up", "🧹");
    vocab.insert("throwing away", "🗑️");
    vocab.insert("recycling", "♻️");
    vocab.insert("planting", "🌱");
    vocab.insert("watering", "💧");
    vocab.insert("harvesting", "🌾");
    vocab.insert("cooking dinner", "🍽️🍳");
    vocab.insert("making breakfast", "🍳☕");
    vocab.insert("eating lunch", "🍽️🥪");
    vocab.insert("feeding pets", "🐕🍽️");
    vocab.insert("walking dog", "🐕🚶");
    vocab.insert("petting cat", "🐈🤲");
    vocab.insert("brushing teeth", "🪥😁");
    vocab.insert("washing hands", "🧼👐");
    vocab.insert("taking shower", "🚿");
    vocab.insert("getting dressed", "👗👚");
    vocab.insert("going to bed", "🛏️😴");
    vocab.insert("waking up", "🌅😃");
    vocab.insert("leaving home", "🏠➡️");
    vocab.insert("coming home", "🏠⬅️");
    vocab.insert("arriving at work", "💼📍");
    vocab.insert("leaving work", "💼➡️");
    vocab.insert("going to school", "🏫➡️");
    vocab.insert("coming from school", "🏫⬅️");
    vocab.insert("starting class", "🏫▶️");
    vocab.insert("ending class", "🏫⏹️");
    vocab.insert("taking test", "📝");
    vocab.insert("passing test", "📝✅");
    vocab.insert("failing test", "📝❌");
    vocab.insert("graduating", "🎓");
    vocab.insert("getting job", "💼✅");
    vocab.insert("losing job", "💼❌");
    vocab.insert("retiring", "👴💼❌");
    vocab.insert("getting married", "💍❤️");
    vocab.insert("having baby", "👶");
    vocab.insert("moving house", "🏠➡️");
    vocab.insert("buying car", "🚗🛒");
    vocab.insert("selling car", "🚗💸");
    vocab.insert("fixing car", "🚗🔧");
    vocab.insert("washing car", "🚗🧼");
    vocab.insert("filling gas", "⛽");
    vocab.insert("charging phone", "📱🔋");
    vocab.insert("calling friend", "📞👫");
    vocab.insert("texting friend", "💬👫");
    vocab.insert("emailing boss", "📧👨‍💼");
    vocab.insert("meeting team", "👥🤝");
    vocab.insert("leading meeting", "👤🧑‍💼");
    vocab.insert("presenting", "👤📊");
    vocab.insert("brainstorming", "🤔💡");
    vocab.insert("solving problem", "🧠✅");
    vocab.insert("making decision", "🤔✅");
    vocab.insert("taking break", "⏸️☕");
    vocab.insert("going on vacation", "✈️🏝️");
    vocab.insert("traveling abroad", "🌍✈️");
    vocab.insert("coming back", "⬅️🏠");
    vocab.insert("staying home", "🏠");
    vocab.insert("visiting family", "👨‍👩‍👧‍👦🏠");
    vocab.insert("hosting party", "🏠🥳");
    vocab.insert("throwing party", "🥳🎉");
    vocab.insert("celebrating birthday", "🎂🥳");
    vocab.insert("celebrating holiday", "🎉🗓️");
    vocab.insert("watching movie", "🎬👀");
    vocab.insert("listening music", "🎵👂");
    vocab.insert("playing music", "🎵🎸");
    vocab.insert("singing song", "🎤🎵");
    vocab.insert("dancing together", "💃🕺");
    vocab.insert("taking photo", "📸");
    vocab.insert("posting photo", "📸📮");
    vocab.insert("liking photo", "📸👍");
    vocab.insert("commenting", "💬");
    vocab.insert("sharing post", "🔁📮");
    vocab.insert("following account", "👣➕");
    vocab.insert("unfollowing account", "👣➖");
    vocab.insert("blocking user", "⛔👤");
    vocab.insert("reporting post", "🚨📮");
    vocab.insert("upvoting", "👍");
    vocab.insert("downvoting", "👎");
    vocab.insert("subscribing", "🔔");
    vocab.insert("unsubscribing", "🔕");
    vocab.insert("logging in", "🔑✅");
    vocab.insert("logging out", "🔑❌");
    vocab.insert("signing up", "📝➕");
    vocab.insert("deleting account", "🗑️👤");
    vocab.insert("resetting password", "🔑🔄");
    vocab.insert("updating profile", "👤🔄");
    vocab.insert("changing settings", "⚙️🔄");
    vocab.insert("turning on", "🔛");
    vocab.insert("turning off", "🔚");
    vocab.insert("charging battery", "🔋⚡");
    vocab.insert("saving file", "💾📄");
    vocab.insert("opening file", "📂📄");
    vocab.insert("closing file", "📄❌");
    vocab.insert("printing document", "🖨️📄");
    vocab.insert("scanning document", "📄🔍");
    vocab.insert("copying text", "📄📋");
    vocab.insert("pasting text", "📋📄");
    vocab.insert("cutting text", "✂️📄");
    vocab.insert("undoing", "↩️");
    vocab.insert("redoing", "↪️");
    vocab.insert("searching", "🔍");
    vocab.insert("finding", "🔎");
    vocab.insert("replacing", "🔄");
    vocab.insert("downloading", "⬇️");
    vocab.insert("uploading", "⬆️");
    vocab.insert("installing", "⬇️⚙️");
    vocab.insert("uninstalling", "🗑️⚙️");
    vocab.insert("updating", "🔄");
    vocab.insert("restarting", "🔄");
    vocab.insert("shutting down", "⏹️");
    vocab.insert("powering on", "🔛");
    vocab.insert("powering off", "🔚");
    vocab.insert("connecting", "🔗");
    vocab.insert("disconnecting", "🔗❌");
    vocab.insert("syncing", "🔄");
    vocab.insert("backing up", "💾⬆️");
    vocab.insert("restoring", "↩️");
    vocab.insert("resetting", "🔄");
    vocab.insert("formatting", "📝");
    vocab.insert("debugging", "🐞🔍");
    vocab.insert("compiling", "🛠️");
    vocab.insert("running", "🏃");
    vocab.insert("testing", "🧪");
    vocab.insert("deploying", "🚀");
    vocab.insert("shipping", "🚚");
    vocab.insert("delivering", "🚚");
    vocab.insert("receiving", "📥");
    vocab.insert("returning", "↩️");
    vocab.insert("exchanging", "🔄");
    vocab.insert("refunding", "💸↩️");
    vocab.insert("paying", "💸");
    vocab.insert("charging", "💳");
    vocab.insert("borrowing", "🤝💸");
    vocab.insert("lending", "💸🤝");
    vocab.insert("investing", "💸📈");
    vocab.insert("donating", "💸❤️");
    vocab.insert("shopping online", "🛒🌐");
    vocab.insert("window shopping", "🪟🛍️");
    vocab.insert("bargain hunting", "🔎💸");
    vocab.insert("price checking", "💲🔍");
    vocab.insert("making offer", "💸🤝");
    vocab.insert("accepting offer", "🤝✅");
    vocab.insert("rejecting offer", "🤝❌");
    vocab.insert("negotiating", "🤝💬");
    vocab.insert("signing contract", "📝🤝");
    vocab.insert("breaking contract", "📝💥");
    vocab.insert("winning prize", "🏆🎁");
    vocab.insert("losing prize", "🎁❌");
    vocab.insert("claiming prize", "🎁✅");
    vocab.insert("giving gift", "🎁➡️");
    vocab.insert("receiving gift", "🎁⬅️");
    vocab.insert("opening gift", "🎁📤");
    vocab.insert("wrapping gift", "🎁📦");
    vocab.insert("sending mail", "✉️➡️");
    vocab.insert("receiving mail", "✉️⬅️");
    vocab.insert("writing letter", "✉️✍️");
    vocab.insert("reading letter", "✉️👀");
    vocab.insert("mailing letter", "✉️📮");
    vocab.insert("delivering letter", "✉️🚚");
    vocab.insert("returning letter", "✉️↩️");
    vocab.insert("throwing letter away", "✉️🗑️");
    vocab.insert("recycling letter", "✉️♻️");
    vocab.insert("writing email", "📧✍️");
    vocab.insert("reading email", "📧👀");
    vocab.insert("sending email", "📧➡️");
    vocab.insert("receiving email", "📧⬅️");
    vocab.insert("deleting email", "📧🗑️");
    vocab.insert("replying email", "📧↩️");
    vocab.insert("forwarding email", "📧➡️➡️");
    vocab.insert("attaching file", "📎📄");
    vocab.insert("downloading attachment", "📎⬇️");
    vocab.insert("uploading attachment", "📎⬆️");
    vocab.insert("opening attachment", "📎📂");
    vocab.insert("closing attachment", "📎❌");
    vocab.insert("saving attachment", "📎💾");
    vocab.insert("printing attachment", "📎🖨️");
    vocab.insert("scanning attachment", "📎🔍");
    vocab.insert("removing attachment", "📎❌");
    vocab.insert("losing attachment", "📎❌");
    vocab.insert("finding attachment", "📎🔎");
    vocab.insert("missing attachment", "📎❓");
    vocab.insert("forgotten attachment", "📎😵");
    vocab.insert("remembered attachment", "📎💾");
    // --- END NEW EMOJI WORDS ---
    vocab.insert("two", "2️⃣");
    vocab.insert("three", "3️⃣");
    vocab.insert("many", "➕");
